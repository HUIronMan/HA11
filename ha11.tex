...
%%Change Title !!!!!!!!!!!!!!!!!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\myTitle}{Exercise Sheet 11}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Aufgabe 1}
\subsection*{Alle Anweisungen sollen überdeckt werden mit einer minimalen Menge von Eingabewerten:}
Die Menge der Eingabepaare (x,y) ist: {(-2,1),(1,1)}
\subsection*{Alle Zweige sollen überdeckt werden mit einer minimalen Menge von Eingabewerten:}
Die Menge der Eingabepaare (x,y) ist: {(-2,-1),(1,1),(-1,-1),(1,20)}
\subsection*{Alle Bedingungen sollen überdeckt  werden mit einer minimalen Menge von Eingabewerten:}
Die Menge der Eingabepaare (x,y) ist: {(-2,-1),(1,1)}
\subsection*{Alle Bedingungen sollen überdeckt werden aber nicht alle Zweige sollen überdeckt werden mit einer minimalen Menge von Eingabewerten:}
Die Menge der Eingabepaare (x,y) ist: {(-2,-1),(1,1)}
...
B subsummiert S.\\
C subsummiert S.\\
C und B sind bezüglich Submission nicht vergleichbar.\\
\\
Die restlichen Fälle treffen nicht zu.
